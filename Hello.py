...
def run():
    ...
    class Car:
        ...
        def get_details(self):
            return f"Location: {self.location}, Fuel: {self.fuel}, Speed: {self.speed}, " \
                   f"Acceleration: {self.acceleration}, Braking: {self.braking}, Steering: {self.steering}"
